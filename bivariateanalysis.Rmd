...
plot(datab$PM10,datab$PM2.5, ylab = "PM2.5", xlab = "PM10")
...
plot(datab$SO2,datab$PM2.5, ylab = "PM2.5", xlab = "SO2")
...
plot(datab$NO2,datab$PM2.5, ylab = "PM2.5", xlab = "NO2")
...
plot(datab$CO,datab$PM2.5, ylab = "PM2.5", xlab = "CO")
...
plot(datab$O3,datab$PM2.5, ylab = "PM2.5", xlab = "O3")
...
#plot PM2.5 vs temp
#matches with strong positive correlation
plot(datab$TEMP,datab$PM2.5, ylab = "PM2.5", xlab = "TEMP")
...
#matches with strong positive correlation
plot(datab$PRES,datab$PM2.5, ylab = "PM2.5", xlab = "PRES")
...
#plot PM2.5 vs DEWP
#matches with strong positive correlation
plot(datab$DEWP,datab$PM2.5, ylab = "PM2.5", xlab = "DEWP")
...
#plot PM2.5 vs rain
#matches with strong positive correlation
plot(datab$RAIN,datab$PM2.5, ylab = "PM2.5", xlab = "RAIN")
...
#plot PM2.5 vs WSPM
#matches with strong positive correlation
plot(datab$WSPM ,datab$PM2.5, ylab = "PM2.5", xlab = "TEMP")
